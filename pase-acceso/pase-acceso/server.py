...
CONFIG = {
    ...
    "DISCORD_CLIENT_ID": os.environ.get("DISCORD_CLIENT_ID", "1545243904486670387"),
    "DISCORD_CLIENT_SECRET": os.environ.get("DISCORD_CLIENT_SECRET", "-T8jMX6XjXiAd_-DF4YCFGvMxhwPlOZZ"),
    "DISCORD_REDIRECT_URI": os.environ.get("DISCORD_REDIRECT_URI", "https://projectltf.onrender.com/oauth/discord/callback"),
